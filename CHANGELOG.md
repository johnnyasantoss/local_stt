...
- **Default local model**: Removed the default model. Pass `--model <name-or-path>` (fuzzy-matched against the HF cache) or set `TCPP_MODEL`; use `--list-models` to see available GGUF models.
